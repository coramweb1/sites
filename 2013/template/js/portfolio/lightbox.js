...
(function () {
	...
	LightboxOptions = (function () {
		function LightboxOptions() {
			...
			this.fileLoadingImage = 'template/images/portfolio/gallery/loading.gif';
			this.fileCloseImage = 'template/images/portfolio/gallery/close.png';
			...
			//this.exLinkUrl = 'http://www.coramwebsolutions.co.za';
